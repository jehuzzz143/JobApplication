...
<script>
    ...
    $('.careerBtnUpdateShort').on('click', function() {
        var ids = $(this).map(function() {
        return $(this).attr('id');
        });
        var id = ids[0];
